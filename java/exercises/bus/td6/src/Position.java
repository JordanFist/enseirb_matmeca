 ...
 **/
class Position {
  static final public Position DEHORS = new Position();
  static final public Position ASSIS = new Position();
  static final public Position DEBOUT = new Position();
