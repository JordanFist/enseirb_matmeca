...
class Jauge{
   ...
   */
  public Jauge(int vigieMax, int depart) throws IllegalArgumentException {
      if (vigieMax < 0)
        throw new IllegalArgumentException("La valeur max de la jauge ne peut pas etre negative\n");
      else {
        valeur = depart;
        max = vigieMax;
      }
