...
class TestAutobus {
    ...
    /*
      ...
      System.out.print('.'); nbTest++;
      new TestAutobus().testExceptionCasLimite();
    ...
    */
	...
	try {
	    bus2 = new Autobus(5, -3);
	    assert false: "Exception non levee";
	} catch (IllegalArgumentException e) {}
	try {
	    bus3 = new Autobus(-5, -3);
	    assert false: "Exception non levee";
	} catch (IllegalArgumentException e) {}

	Autobus bus4 = new Autobus(10, 10);
	FauxPassager faux = new FauxPassager();
	bus4.monteeDemanderAssis(faux);
	try {
	    bus4.monteeDemanderAssis(faux);
	    assert false: "Exception non levee";
	} catch (IllegalStateException e) {}

	Autobus bus5 = new Autobus(10, 10);
	FauxPassager faux2 = new FauxPassager();
	bus5.monteeDemanderDebout(faux2);
	try {
	    bus5.monteeDemanderDebout(faux2);
	    assert false: "Exception non levee";
	} catch (IllegalStateException e) {}
