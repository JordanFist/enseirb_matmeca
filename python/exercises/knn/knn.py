...
if __name__ == '__main__':
    ...
    #TODO
    features = [0, 1, 2, 3, 4, 5, 6, 7, 10, 12]
    ...
    x_train, x_test, y_train, y_test = load_dataset("breastcancer", features, 0.66)
    
    # Lists to save results in
    train_scores = [0] * k_max
    test_scores = [0] * k_max
    ...
    for k in range (1, k_max + 1):
        ...
        train_scores[k - 1], test_scores[k - 1] = evaluate_knn(knn, x_train, y_train, x_test, y_test)
    
    # Construct plot
    plt.title('Breast cancer with test size = 66%')
